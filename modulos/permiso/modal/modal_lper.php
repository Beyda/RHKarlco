...
<script type="text/javascript" src="/rhkarlco/bootstrap/js/scripts.js"></script>
                ...
                <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                    <?php
                    $ctr_emp = "SELECT `id_permiso`, `fecha`, `etapa`, `id_puesto` FROM `permisos` WHERE `id_solicitante` = $id_emp";
                    ...
                    while ($row_resemp = $res_emp->fetch_array()) {
                      ...
                      <tr>
                        ...
                        <td><center><a href="../pdf/permisos.php?id=<?php echo $row_resemp[0] ?>" target="blanck"><button class="btn bg-blue margin" style="width: 50%;">Ver</button></a></center>
