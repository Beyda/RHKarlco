	...
	<div id="dd">
		<table id="distribuidos">
			...
			<tr>
				...
				<td id="verde"><?php echo $row_datos[18]; ?></td>
			</tr>
			<tr>
				<td>Enfermedad de un familiar</td>
				<td id="verde"><?php echo $row_datos[19]; ?></td>
			</tr>
			<tr>
				<td>Tramite de Visa</td>
				<td id="verde"><?php echo $row_datos[20]; ?></td>
			</tr>
			<tr>
				<td>Asunto personal</td>
				<td id="verde"><?php echo $row_datos[21];?></td>
			</tr>
			<tr>
				<td>Otros</td>
				<td id="verde"><?php echo $row_datos[22]; ?></td>
			</tr>
		</table>
		...
		<table id="distribuidos">
			...
			<tr>
				...
				<td id="verde"><?php echo $row_datos[23]; ?></td>
			</tr>
			<tr>
				<td>Nacimiento hijo</td>
				<td id="verde"><?php echo $row_datos[24]; ?></td>
			</tr>
			<tr>
				<td>Defunción Familiar Directo</td>
				<td id="verde"><?php echo $row_datos[25]; ?></td>
			</tr>
			<tr>
				<td>Reposición de día</td>
				<td id="verde"><?php echo $row_datos[26]; ?></td>
			</tr>
			<tr>
				<td>Otros</td>
				<td id="verde"><?php echo $row_datos[27]; ?></td>
			</tr>
		</table>
		...
		<table id="distribuidos">
			...
			<tr>
				...
				<td id="verde"><?php echo $row_datos[28]; ?></td>
			</tr>
			<tr>
				<td>Asunto Personal</td>
				<td id="verde"><?php echo $row_datos[29]; ?></td>
			</tr>
			<tr>
				<td>Otros</td>
				<td id="verde"><?php echo $row_datos[30]; ?></td>
			</tr>
		</table>
	</div>
