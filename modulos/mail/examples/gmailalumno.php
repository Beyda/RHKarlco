...
$correo=$_GET['e'];
$telefono=$_GET['t'];
$id_usuario=$GET['t_usuario'];
$id_inscripcion=$GET['id_inscripcion'];
...
//Quien lo envia
$mail->setFrom('1100251@unav.edu.mx', 'Nueva Inscripcion, INAES');
...
$mail->Subject = 'Nueva Inscripcion INAES de: '.$nombre.' '.$a_paterno.' '.$a_materno;
...
if (!$mail->send()) {
    ...
    echo "Message sent!";
    header("Location: /inaes/inscripciones/admin/alumno_inscripciones.php?nombre=$nombre&correo=$correo");
