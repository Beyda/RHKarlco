                    ...
                    <div class="col-lg-6">
                      <div class="input-group">
                        <?php
                          ...
                          <center><a href="/rhkarlco/modulos/empleados/m_empleados.php?id=<?php echo $id ?>"><button class="btn bg-olive margin">Editar datos personales</button></a></center>
                      </div><!-- /input-group -->                    
                    </div><!-- /.col-lg-6 -->
                  </div><!-- /.row -->
                  </div><!-- /.form group -->
...
<!-- ========================== BENEFICIARIOS EN CASO DE FALLECIMIENTO ============================== -->
          <?php
            $ctr_benfa = "SELECT * FROM `beneficiarios` WHERE `id_datosper` = $id";
...
<!-- ========================== Datos familiares o independientes ================================= -->
          <?php
            $ctr_Datfami = "SELECT * FROM `datos_familiares` WHERE `id_datosper` = $id";
...
<!-- ========================== Empleos anteriores ================================= -->
          <?php
            $ctr_empant = "SELECT * FROM `empleos_anteriores` WHERE `id_datosper` = $id";
...
<!-- ========================== Estudios anteriores ================================= -->
<?php
            $ctr_estant = "SELECT * FROM `estudios` WHERE `id_datosper` = $id";
        ...
        <section class="content">
          <div class="row">
            <div class="col-xs-12">
              ...
              <div class="box">
                <div class="box-header">
                  <a href="modal/modal_ea.php" data-toggle="modal" data-target=".modalProf" class='modalLoad'><button class="btn btn-block btn-primary btn-sm">Insertar estudios anteriores</button></a>
                </div><!-- /.box-header -->
                <div class="box-body">
                  <table id="example1" class="table table-bordered table-striped">
                    <thead>
...
<!-- ========================== Referencias Personales ================================= -->
          <?php
            $ctr_ref = "SELECT * FROM `referencias` WHERE `id_datosper` = $id";
...
<!-- ========================== Habilidades ================================= -->
         <?php
            $ctr_habi = "SELECT DISTINCT lh.*, h.* FROM `habilidades` h INNER JOIN `l_habilidad` lh ON h.`id_lhab` = lh.`id_lhab`  WHERE h.`id_datosper` = $id";
        ...
        <section class="content">
          <div class="row">
            <div class="col-xs-12">
              ...
              <div class="box">
                <div class="box-header">
                  <a href="modal/modal_prof.php" data-toggle="modal" data-target=".modalProf" class='modalLoad'><button class="btn btn-block btn-primary btn-sm">Insertar nueva habilidad</button></a>
                </div><!-- /.box-header -->
                <div class="box-body">
                  <table id="example1" class="table table-bordered table-striped">
                    <thead>
...
<!-- ========================== Documentos necesarios a entregar ================================= -->
          <?php
            $ctr_doc = "SELECT * FROM `documentos` WHERE `id_datosper` = $id";
                ...
                <form action="javascript:void(0);">
                  <div class="form-group">                  
                    ...
                    <label>Tipo</label>
                      ...
                      <?php
                     $obt_tdoc = "SELECT distinct * FROM `tipo_doc` WHERE `tipo_doc`.`id_tdoc` NOT IN (SELECT `id_tdoc` FROM `documentos` WHERE `id_datosper` = $id and `tipo_doc`.`id_tdoc` = `documentos`.`id_tdoc`)";       
