                  ...
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    while ($row_resemp = $res_emp->fetch_array()) {
                      ...
                      <tr>
                        ...
                        <td><center><a href="l_subareas.php?id=<?php echo $row_resemp[0]?>"><button class="btn bg-olive">Ver</button></a></center></td>
                        <?php 
                        if($row_resemp[2] == 1)
                        {
                        ...
                        ?>
                        <td><center><a href="modal/modal.php?id=<?php echo $row_resemp[0]?>" data-toggle="modal" data-target=".modal" class='modalLoad'><button class="<?php echo $color; ?>"><?php echo $estatus ?></button></a></center></td>
                      </tr>
                      <?php
                        }
                        ?>
